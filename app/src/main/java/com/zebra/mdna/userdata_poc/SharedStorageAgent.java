...
public class SharedStorageAgent extends FullBackupAgent {
    static final String TAG = "ZEBRA-AJAY";
    static final boolean DEBUG = true;

    StorageVolume[] mVolumes;
    SharedStorageAgent(Context context){
        super();
    }
    ...
    public void onFullBackup(FullBackupDataOutput output) throws IOException {
        ...
        Log.d(TAG, "onFullBackup: START");

        fullBackupFileTree("com.zebra.zebrafactoryreset", FullBackup.SHAREDPREFS_TREE_TOKEN, "/data/data/com.zebra.zebrafactoryreset",
                null /* manifestExcludes */,
                null /* systemExcludes */, output);
